...
public class RejectTask extends AsyncTask<String, Void, String> {

    @SuppressLint("StaticFieldLeak")
    Context context;
    ReservationInterface reservationInterface;

    public RejectTask(Context context, ReservationInterface reservationInterface) {
        super();
    ...
    protected void onPostExecute(String s) {
       reservationInterface.rejectResult(s);
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL url = new URL("http://trainingmia.000webhostapp.com/reject.php");
